...
pretrained_model=/root/model/chinese-alpaca-2-7b
chinese_tokenizer_path=/root/model/chinese-alpaca-2-7b
dataset_dir=/root/train/Chinese-LLaMA-Alpaca-2/data
per_device_train_batch_size=1
per_device_eval_batch_size=1
gradient_accumulation_steps=8
max_seq_length=512
output_dir=/root/test2/
validation_file=/root/train/Chinese-LLaMA-Alpaca-2/data1/xx1.json
